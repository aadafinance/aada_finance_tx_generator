...
const Index = () => {
  ...
  return (
    <div className={styles.container}>
      <h1 className={styles.title}>Cancel liquidity request</h1>
      {networkId === 1 && (
        <>
          <br />
          <div>
      ...
      <br />
        <div>
            <label>
                <span className={styles.label}>Borrower Tn</span>
      ...
      <div>
        <button disabled={!canTransact} className={styles.button} onClick={tx.cancelLiquidityRequest}>
          Send transaction
        </button>
        <label>
          <br></br>
