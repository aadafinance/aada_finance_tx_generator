...
const Index = () => {
  ...
  return (
    <div className={styles.container}>
      <h1 className={styles.title}>Withdraw interest</h1>
      {networkId === 1 && (
        <>
          <br />
          <div>
    ...
    <div>
        ...
        <div>
            <label>
                <span className={styles.label}>Repaid loan TX hash</span>
      ...
      <div>
        <button disabled={!canTransact} className={styles.button} onClick={tx.withdrawInterest}>
          Send transaction
        </button>
        <label>
          <br></br>
