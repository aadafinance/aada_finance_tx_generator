...
const Index = () => {
  ...
  return (
    <div className={styles.container}>
      <h1 className={styles.title}>Withdraw collateral</h1>
      {networkId === 1 && (
        <>
          <br />
          <div>
    ...
    <div>
        ...
        <div>
            <label>
                <span className={styles.label}>Liquidation TX hash</span>
      ...
      <div>
        <button disabled={!canTransact} className={styles.button} onClick={tx.withdrawCollateral}>
          Send transaction
        </button>
        <label>
          <br></br>
